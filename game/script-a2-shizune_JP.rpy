...
n " {vspace=60}翌朝、昨日の夜はなんてすばらしかったのだろうと記憶を反芻する。思い出が強すぎて、考えるのをやめることができない。"
...
n " {vspace=60}まあ、少なくとも今朝は天気がいいから、始業前に外で予習ができるな。"
...
n " {vspace=60}教室にいるよりは外にいるほうがずっと気分がすっきりする。静かなのは言うまでもない。今日はみんな相当遅くまで寝ているんじゃないか、と思い始める。"
...
n " {vspace=30}かわいらしいじゃないか。静音が考えたんだろうか？　あいつのことだから、意図的にやったに違いない。俺がそのことに気づいて、自分たちが苦労して成し遂げたものを目の当たりにすることを期待していたのか？"
...
n " {vspace=60}一生の中で一番長い２０分だったような気がする。それもみんな、メモ帳をやりとりすることで一対一の会話をするなんて経験が今まで全くなかったからだ。おかげでほぼずっと頭の中が真っ白だった。"
...
n " {vspace=60}男子が朝っぱらから何気なく女子寮の中をうろついているなんて許されないだろうけど、静音の目の前でミーシャに手話クラスのことを聞くなんて絶対にありえない。"
...
n " {vspace=60}結局、かなり長い間待つことになった。生徒たちが学校に集まる間、ミーシャは遅刻だろうかと疑問を抱く。"
...
n " {vspace=60}手話の先生によくやっているとほめられた。"
...
n " {vspace=30}１歩ずつ着実にそこにたどり着くために、俺は全力を尽くしている。昼休みにできる限りのことを詰め込んでいるんだ。"
...
n " {vspace=60}ミーシャは俺の顔を見るたびに、手話を勉強していることを静音に隠す理由を聞いてくる。"
...
n " {vspace=30}だから俺にとっては、これ以外に選択肢はない。自分でこんなに強く決意したのだから、なおさらだ。"
...
n " {vspace=30}暮らしは以前の通りに戻った。まあ、かなり珍しい時期に転入したし、そもそも最初の数週間だって普通だったとは言いがたい。どちらかと言えば、色々なことがだんだん落ち着いて、正常になったんだろう。"
...
n " {vspace=150}静音は俺が手話の授業を受けていたことを昨日ずっと知っていて、でも何も詮索しなかった。"
...
n " {vspace=150}でも俺の不安が静まるにつれて、しばらくミーシャ抜きで静音と二人きりで過ごさないといけないことに思いが至る。昨日はあまり気にしなかったけど、どんどん心配になってくる。確かにもう手話はかなり理解できるようになった、でも……"
...
n " {vspace=30}お前のことが好きだ、と伝えたい。はっきりと、一息に。でもこんなことを考えるだけでも、とんでもなく気まずい気分になってくる。"
...
n " {vspace=270}俺が卵の殻でできているかのような、そして他人を抱きしめる方法を知らないかのような、不安げで注意深い抱擁だった。でも正直言うと、俺だってそんなに詳しいわけじゃない。"
