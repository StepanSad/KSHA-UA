...
init 1:
    ...
    image ev emi_knockeddown_facepullout:
        ...
        size (1920,1080)  crop (2016, 90, 1920, 1080)  subpixel True 
        easeout 10.0  crop (2016, 90, 2112, 1188) 

    image ev emi_knockeddown_largepullout:
        "event/emi_knockeddown.jpg" 
        size (1920,1080)  crop (96, 54, 1728, 972)  subpixel True 
    ...
    image ev emi_run_face_zoomin:
        ...
        size (1920,1080)  crop (0, 0, 1920, 1080)  subpixel True 
    ...
    image ev emi_run_face_zoomout_ss:
        ...
        size (1920,1080)  crop (40*2.4, 30*1.7, 1720, 970)  subpixel True 
    ...
    image ev rin_eating_zoomout:
        ...
        size (1920,1080)  crop (332,0,1536,864)  subpixel True 
    ...
    python:
        def roofcomposite(comppath):
            return im.Composite(None,
                                        ...
                                        (300*2.4, 200*1.5), comppath)

    image ev hisao_mirror = "event/hisao_mirror.jpg"
    image ev hisao_mirror_800 = im.FactorScale("event/hisao_mirror.jpg", 1.0)
    ...
    image ev rin_nap_total_awind_tears = LiveComposite((1920,1080),
                                                       (0,0), "ev rin_nap_total_awind",
                                                       (0,0), "ev rin_nap_total_tears")
    image ev rin_nap_close_awind_tears = LiveComposite((1920,1080),
    ...
    python:
        d_rin_h2_pan_surprise = im.Composite((1920,2160),
    ...
    image unlock_evh rin_h2_pan_surprise = im.Crop(d_rin_h2_pan_surprise,0,0,1920,1080)

    python:
        d_rin_h2_pan_away = im.Composite((1920,2160),
                                               (0,0), "event/rin_h2/rin_h2_u_away.jpg",
                                               (0,720), "event/rin_h2/rin_h2_l_pan.jpg")
    image evh rin_h2_pan_away = d_rin_h2_pan_away
    image unlock_evh rin_h2_pan_away = im.Crop(d_rin_h2_pan_away,0,0,1920,1080)

    python:
        d_rin_h2_pan_closed = im.Composite((1920,2160),
                                                 (0,0), "event/rin_h2/rin_h2_u_closed.jpg",
                                                 (0,720), "event/rin_h2/rin_h2_l_pan.jpg")
    image evh rin_h2_pan_closed = d_rin_h2_pan_closed
    image unlock_evh rin_h2_pan_closed = im.Crop(d_rin_h2_pan_closed,0,0,1920,1080)

    image evh rin_h2_nopan_closed = im.Composite((1920,2160),
                                     (0,0), "event/rin_h2/rin_h2_u_closed.jpg",
                                     (0,720), "event/rin_h2/rin_h2_l_nopan.jpg")

    image evh rin_h2_hisao_surprise = im.Composite((1920,2160),
                                     (0,0), "event/rin_h2/rin_h2_u_surprise.jpg",
                                     (0,720), "event/rin_h2/rin_h2_l_hisao.jpg")

    image evh rin_h2_hisao_away = im.Composite((1920,2160),
                                     (0,0), "event/rin_h2/rin_h2_u_away.jpg",
                                     (0,720), "event/rin_h2/rin_h2_l_hisao.jpg")

    image evh rin_h2_hisao_closed = im.Composite((1920,2160),
                                     (0,0), "event/rin_h2/rin_h2_u_closed.jpg",
                                     (0,720), "event/rin_h2/rin_h2_l_hisao.jpg")
    ...
    image evh_hi shizune_hcg_tied_hisao2 = im.Composite((3840,2880),
                                                        (2592,696),"event/shizune_hcg_tied/shizune_hcg_tied_hisao2.png")
    image evh_hi shizune_hcg_tied_hisao2_small = im.Composite((1920,1080),
                                                              (1296,224),"event/shizune_hcg_tied/shizune_hcg_tied_hisao2_small.png")


    image evhul shizune_hcg_tied_hisao2_small = im.Composite((1920,1080),
    ...
    image ev shizu_goodend:
        ...
        xalign 0.5  yalign 0.85  subpixel True 
    ...
    image ev kenji_rooftop_kenji = im.Crop("event/kenji_rooftop_large.jpg", 288*2.4,376*1.6,1920,1080)
    ...
    image ev emi_bed_full = LiveComposite((1920,2967),
    ...
    image fireshine = LiveComposite((1920, 1080),
    ...
    image hanako_fw = LiveComposite((1920, 1080),
    ...
    image rain normal = LiveComposite((1920, 1080),
                             (0,0), rainAnim(),
                             (0,0), rainAnim(my_offset=0.1, zoom=1.2),
                             )


    image rain light = LiveComposite((1920, 1080),
                             (0,0), rainAnim(alpha=0.3),
                             (0,0), rainAnim(my_offset=0.1, zoom=1.2, alpha=0.3),
                             )

    image rain medium = LiveComposite((1920, 1080),
...
init python:
    ...
    letterbox = LiveComposite((1920, 1080),
    ...
    snowfg = SnowBlossom("vfx/snowflake.png", start=3.0, count=20, border=50, xspeed=(20, 50), yspeed=(120, 180), fast=True)
    snowbg = SnowBlossom(im.Scale("vfx/snowflake.png",5,5), count=30, yspeed=(80, 120), start=3.0, border=50, xspeed=(20, 50), fast=True)
    renpy.image("snow",LiveComposite((1920,1080),
                                         (0,0),snowbg,
                                         (0,0),snowfg))
    ...
    sakura = SnowBlossom(anim.Filmstrip("vfx/sakura.png", (20, 20), (2, 1), .25), xspeed=(150, 100), yspeed=(75, 150), count=80, fast=True)
    ...
    def main_menu_composer(is_animated):
        ...
        widget_map = [('tc_act4_shizune', (1491, 479), '16_tc4-shizune.png'),
                          ('tc_act3_shizune', (1508, 645), '15_tc3-shizune.png'),
                          ('tc_act2_shizune', (1393, 832), '14_tc2-shizune.png'),
                          ('tc_act4_rin', (1183, 248), '13_tc4-rin.png'),
                          ('tc_act3_rin', (1304, 338), '12_tc3-rin-rin.png'),
                          ('tc_act3_rin', (1409, 454), '11_tc3-rin-hisao.png'),
                          ('tc_act2_rin', (1409, 681), '10_tc2-rin.png'),
                          ('tc_act4_lilly', (1053, 283), '09_tc4-lilly.png'),
                          ('tc_act3_lilly', (1183, 439), '08_tc3-lilly.png'),
                          ('tc_act2_lilly', (1302, 630), '07_tc2-lilly.png'),
                          ('tc_act4_hanako', (888, 439), '06_tc4-hanako.png'),
                          ('tc_act4_emi', (881, 621), '05_tc4-emi.png'),
                          ('tc_act3_emi', (993, 786), '04_tc3-emi.png'),
                          ('tc_act2_emi', (1069, 876), '03_tc2-emi.png'),
                          ('tc_act3_hanako', (1058, 500), '02_tc3-hanako.png'),
                          ('tc_act2_hanako', (1124, 645), '01_tc2-hanako.png'),
                          ('tc_act1', (1260, 826), '00_tc1-hisao.png')]
        
        basedelay = 0.07
        delay = basedelay * len (widget_map)                       
        widget_list = [(1920,1080), (0,0), "ui/main/bg-main.png", (1745,1015),Text(game_version+"\n"+renpy.version()+"\nRemastered by Letow",color="#00000080", size=15, font="font/playtime.ttf")]
    ...
    style.note_window.top_padding=30
    style.note_window.left_padding=45
    style.note_window.right_padding=35
    ...
    style.comment_frame.xminimum = 1920
    ...
    style.gm_nav_frame.yalign = 0.3
    style.gm_nav_frame.xminimum = 400
    style.gm_nav_frame.yminimum = 760
    ...
    style.yesno_prompt_text.size = 35

    style.yesno_frame.xalign = 0.5
    style.yesno_frame.yalign = 0.5
    style.yesno_frame.xmaximum = 530
    style.yesno_frame.yminimum = 277
    style.yesno_frame.ymaximum = 277

    style.yesno_frame.xmargin = 0
    style.yesno_frame.background = "ui/bg-popup.png"
    style.yesno_prompt.yminimum = 80
    style.yesno_prompt.color = "#00000066"
    style.yesno_button_hbox.box_spacing = 40
    ...
    style.file_picker_text = Style(style.prompt_text, help="text inside a file picker entry")
    ...
    style.file_picker_frame = Style(style.default, help="the frame enclosing the entire file picker")
    ...
    style.file_picker_frame.xminimum = 580
    ...
    style.file_picker_entry.xminimum=669
    style.file_picker_entry.xmaximum=669
    style.file_picker_entry.yminimum=115
    style.file_picker_entry.background = ib_base("ui/bt-scribble.png")
    style.file_picker_entry.hover_background = "ui/bt-scribble.png"
    style.file_picker_entry.top_padding = 6

    style.vscrollbar.thumb_offset = -10
    style.vscrollbar.ymaximum = 500
    style.vscrollbar.xmaximum = 48
    style.vscrollbar.top_gutter = 30
    style.vscrollbar.bottom_gutter = 28
    ...
    style.vscrollbar2.ymaximum = 448
    ...
    style.prefs_pref_frame.yminimum = 30
    style.prefs_column.xanchor = 0.5

    style.prefs_pref_box.box_spacing = 12

    style.prefs_column.xmaximum = 500
    ...
    style.prefs_slider.ymaximum = 60

    style.prefs_pref_box.xfill = True
    style.prefs_volume_box.xfill = True
    style.prefs_pref_choicebox.xfill = True
    style.prefs_pref_box.yfill = True
    style.prefs_volume_box.yfill = True
    style.prefs_pref_choicebox.yfill = True
    ...
    style.prefs_pref_frame.bottom_padding = 100
    ...
    style.prefs_label.yalign = 0.5
    style.prefs_label_text.take(style.prompt_text)
    style.prefs_label_text.size = 34
    ...
    style.prefs_slider.left_gutter = 20
    style.prefs_slider.right_gutter = 20
    style.prefs_slider.xmaximum = 400
    style.prefs_slider.ymaximum = 60
