...
n "\n\n\nКаждый в «Ямаку» – «особенный», что сводит на нет всю эту «особенность»."
...
n "\nИли, быть может, я единственный, кто воспринимает нашу форму как клеймо? Возможно, я привыкну к ней через некоторое время, как и к любой другой школьной форме."
...
n "\nНо, так или иначе, и её, и мои шрамы напоминают мне о причине, по которой мы здесь находимся."
