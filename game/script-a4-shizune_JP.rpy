...
n " {vspace=60}優子さんは静かに、俺が持ってきた本の返却処理を始める。司書というよりは爆弾処理の技術者のように、大変な丁寧さと正確さで本を扱っている。"
...
n " {vspace=60}ミーシャは実際には見た目よりもずっと繊細だった。静音の態度に打ちひしがれてしまったのだろう。静音は結構冷たく応じることもあるから、なおさらだ。静音がどういう反応をしたかは知らないけど、たぶんそうだったのだろうし、俺にはその理由もわかる。"
...
n " {vspace=30}誰かにこのことを話せたらいいかもしれないな。"
...
n " {vspace=60}何も悩むことなんてないと言ってやりたい。お前は人を励ますのがとてもうまいんだ、だって俺がここに来た最初の週に、俺を励ますことができたじゃないか、と。"
...
n " {vspace=60}文化祭を静音と過ごしたおかげで、マンネリな気分から抜け出すことができた。その間ずっと、静音に操られているような気がしていたことを忘れるくらい、楽しかった。あの時の俺は静音に操られてもいいと思っていたんだ、と今になって理解する。"
...
n " {vspace=60}世界のどん底にいたような気分だったけど、今でも俺は普通の生活を取り戻したいと思っている。それは確かだ。俺は今の生活を楽しんでいるから。それは誰しも同じに違いない。ミーシャも含めて。みんな自分を苦しみの中から引き上げてくる人が欲しいんだ。"
...
n " {vspace=30}静音の目を見ればわかる。落ち込んだミーシャを励ますのに、他の問題と同じようなやり方で臨もうとしているけど、今度ばかりはそうはいかない。静音の思考過程は全然違う。ある意味ではより慎重、ある意味ではもっと向こう見ずで熱狂的だ。そのくらいには気を使っているんだ。"
...
n " {vspace=150}結局、俺は何も言わない。こうやって二人きりで隣に座っているのが心地よくて、質問でこのひとときを壊したくない、というのもあった。"





n " {vspace=60}怖かったからでもある。実際はそうじゃないと思うけど、あの日の静音の行動は全て思いつき、まぐれ、もしくは偶然の連続だったのかもしれない。そうだったとしても何も変わらないけど、そう考えると居心地が悪くなる。"
...
n " {vspace=60}優子さんが静音はある意味で勇気がある、と言っていたのを思い出す。今なら優子さんの言いたかったことが分かるし、それに同意せざるをえない。それは無謀さ、愚かさ、無意味な頑固さと呼べるかもしれないけど、『勇気』と言ってもいいのかもしれない。"
...
n " {vspace=30}自分がどこで間違えて、ミーシャとの関係をこんなにこじらせてしまったのか、静音は俺なんかよりもずっと長い間、根気強く考えていたはずだ。でも静音にありがちなことだけど、そのことを引け目に感じたりせず、すぐに問題を解決しようとする。"
...
n " {vspace=60}静音のようなものの考え方は普通じゃない。たいていの普通の人なら、友達を拒絶したあとで、あっさり元の関係に戻れるなんて考えたりしない。でも静音はそう考えている。なぜなら静音は人生というのは、あえて簡単に言うと、切り分けて区分できるものと見ているからだ。"
...
n " {vspace=30}静音は自分自身にとっても静音でしかない。おそらく静音は、他人の人生を引っかき回している限り、自分の行動の長期的な影響なんて考えもしていない。でもミーシャにとってそれは英雄的に見えたのだろう。優子さんや俺が静音の勇敢さに感心したように。"
...
n " {vspace=30}二人の違いについて考えている途中で、ある考えが頭の中で浮かび始める。"
...
n " {vspace=270}あの週からは何の混乱も起きていない。"

nvl clear


n " {vspace=30}もちろん、そう思ったのはその前の週のことだ。そして静音とミーシャが突然悟りを開いたことに、俺は少しとまどいと嫉妬を覚えていた。その時は、自分が安心していられるわけがないと思っていた。"
...
n " {vspace=60}俺たちの生徒会が、これから引き継ごうとしている新生徒会と同じくらいに大きくなっていたら、どうなっていただろう。"
...
n " {vspace=30}だからある意味、俺もその同じ木を遠くから見ているような気分になっている。通り過ぎる列車の窓から見ているかのように。"
...
n " {vspace=120}この二人が忙しかっただろうっていうのはわかってる。でも俺はもう自分のやりたいことを見いだした。それに気づいたときも、特に興奮や不安は感じなかった。"


n "その逆だ。ずいぶん久しぶりに、俺は穏やかな気持ちになっている。その感覚をもう少しの間味わっていたい。"


n " {vspace=30}ここで教師になりたい、と思う。"


n " {vspace=30}それに思い至ったとき、曲がりくねった長い道が頭の中に現れた。ここに戻ってくる、はっきりしない道だ。"

nvl clear


n " {vspace=120}将来、俺みたいな誰かに会うことができるだろうか。苦しみに満ちあふれた誰かに。"
...
n " {vspace=120}『何を黙ってるんだよ？』。とても冗談を言っている場合ではないけど、そんな言葉がすぐに頭に浮かぶ。今の俺の気持ちではある。俺たちは普通に会話をすることはできないから、そうできるわずかな手段だけでも俺にはありがたい。こんな風に拒絶されると傷つく。"
...
n " {vspace=30}なぜか、そのせいで余計に理由が知りたくなる。つまりミーシャに聞かないといけないということだ。問題は、俺はミーシャが暇な時間に何をしているかを知らない。"
...
n " {vspace=60}俺は口先だけで、何も問題ないなんて白々しい嘘を静音についた。いや、正確には手で嘘をついた、か。それと全く同時に、まるで違うことをミーシャと話していた。"
...
n " {vspace=30}つじつまは合う。唇を読むときに読み間違える可能性はあるけど、何の足しにもなりはしない。"
