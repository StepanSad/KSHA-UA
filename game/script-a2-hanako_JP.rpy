...
n " {vspace=120}山久学園ではみんなが『特別』で、それは『特別』であることの『特別さ』を打ち消している。"
...
n " {vspace=30}それとも、これを不名誉な代物として見ているのはもしかして俺だけなのか？　しばらくすれば他の学校の制服のように慣れるのだろうか。"
...
n " {vspace=60}とはいったものの、思い返してみるとこの町に『普通な』ところなどないようだけど、それは悪い意味のものじゃない。"
...
n " {vspace=30}でもある意味では、俺と華子の傷跡は俺たちがみんな理由があってこの場所にいるんだということを思い出させてくれる。"
...
n " {vspace=120}ここまで考えて、俺は朝食の時にリリーから投げかけられた質問を思い出す。"
...
n " {vspace=60}俺は入院していたとき一度、火傷患者の病棟に行ったことがある。本当に一度だけだけど。退屈を紛らわせるために、全ての病棟を歩き回っていたんだ。"
...
n " {vspace=30}もし入院中に本がなかったら、俺は気が狂っていただろう。"
