...
n " {vspace=90}武藤先生の授業の間ずっと、俺の頭の中で様々な思いが渦巻いている。"
...
n " {vspace=30}授業が終わったあとも、笑美と俺がこうも簡単に顔を合わせずにいられることがおかしい。"
...
n " {vspace=60}笑美は普段よりも気を取られることが多くなったように見える。気が立ったようにそわそわしている様子を一度ならず目撃している。"
...
n " {vspace=180}武藤先生はどのみち俺の科学のテストは万全だと思ってる。"
...
n " {vspace=90}テストさえ終われば、肩の荷も降りるだろうな。"
...
n " {vspace=60}あるいは、今あるものを楽しんでいるべきなのかもしれない。"
...
n " {vspace=60}もし笑美を怒らせてしまったらどうしよう？"
...
n " {vspace=60}今度の……笑美のことの後では、もう自信が持てない。"
...
n " {vspace=150}笑美は文字通りなにかから逃げている――けど俺は笑美と同じように、入院生活のことをどうにかして忘れ去ろうとしてきたんじゃなかったのか？"
...
n " {vspace=30}笑美の苦労は俺みたいに心臓じゃなくて２つの足だけど、それだって魔法のように勝手に治ったりはしない。"
...
n " {vspace=30}もしかしたら、俺たち二人の仲はここまでしか直らないのかもしれない。"
...
n " {vspace=30}『そうじゃなきゃだめなの』"





n " {vspace=30}そんなのひどすぎるじゃないか。"
...
n " {vspace=120}ランニングそのものが楽しみになってきている。"
...
n " {vspace=30}ランニングを終えたときはとても気持ちがいい。その日他に何もできなかったとしても、少なくともそれだけはやり遂げたことになる。"
...
n " {vspace=120}昨日の夜のことを乗り越えたと思うたびに、笑美が優しげなことを言ったりしたりして、俺は振り出しにもどる。"
...
n " {vspace=90}俺はバスに乗るのは好きじゃないほうだと思う。"
...
n " {vspace=30}ついでに笑美の足がガチャガチャという音を立てて、他の乗客たちに注目されてしまっている。"
...
n " {vspace=90}俺がそわそわと席での座り方を変えていると、笑美はいぶかしげに片眉を上げる。"
...
n " {vspace=60}聞いたとしても教えてくれることはないだろうけど。"
...
n " {vspace=90}そうは見えないかもしれないけど、笑美は俺のことを信頼しているとナースは言った。"
...
n " {vspace=30}ナースもそうしているだけかもしれない。"



n " {vspace=30}だけど、さっきのナースは笑美が俺を招待したことに純粋に驚いているようだった。あの表情には何かがあった……"
...
n " {vspace=30}あとは心臓と同じように笑美との関係さえなんとかできれば、俺は絶好調と言えるだろう。"
...
$ written_note("２月と３月の、あの静かな日々に戻れるなら、自分をあきらめないで、とあなたに伝えると思います。きっとそう言います。なんでもいいからあなたに話しかけてさえいれば、こんなに遠くへ行ってしまうこともなかったかもしれません。あなたが自分の力で立ち直れているといいな、と思います。 {vspace=120} ")
...
n " {vspace=90}岩魚子、ありがとう。あの冬の雪の日、俺はお前の告白に『はい』と答えを返すつもりだった。そうはならなかったけれど。"
...
n " {vspace=60}そしてその過去は俺に大切なことを教えてくれたのかもしれない。"
...
n " {vspace=60}これからどうしよう？　ベッドから起き上がって、校庭に行って、何事もなかったふりをする？"
...
n " {vspace=30}俺は本当に笑美に会いに行くことができるのか？　この状況から前進することができないとわかっていても？"
