...
"По прошествии приличного количества времени мне в голову приходит мысль, что это – очередной психологический тест за авторством %(name_shizune)s. Даже если я ошибаюсь, время-то не стоит на месте."
...
$ renpy.music.set_volume(0.59999999999999998, 2.0, 'ambient')
...
mi "Нет, но неважно, неважно~! Пойдём, %(name_hicchan)s, пока толпа не собралась!"
...
mi "%(name_shiraki)s, мы бы хотели поиграть, ведь можно?"
...
mi "Если ты только не хочешь оставить её себе, %(name_hicchan)s. Не знала, что тебе нравятся мягкие игрушки. Как щекотливо."
...
$ renpy.music.set_volume(0.40000000000000002, 10.0, 'ambient')
...
$ renpy.music.set_volume(0.29999999999999999, 1.0, 'ambient')
...
$ renpy.music.set_volume(0.10000000000000001, 2.0, 'ambient')
...
"И я чувствую силу личности %(name_shizune)s, подчёркивающей эту точку зрения."
...
stop music fadeout 3.0
$ renpy.music.set_volume(0.59999999999999998, 0.0, 'ambient')
play ambient sfx_crowd_outdoors fadein 1.0
...
with Pause(4)
$ renpy.music.set_volume(1.0, 0.20000000000000001, 'ambient')
play ambient sfx_fireworks fadein 1.0
...
$ written_note(u"{size=55}{b}ВХОД ВОСПРЕЩЁН{/b}{/size}", quiet=True)
...
$ doublespeak(ke, hi, u"Привет.", u"А-А-А-А-А-А-А-А-А!")
...
"Я решаю поиграть с собой в игру-напивашку. Каждый раз, как %(name_kenji)s упоминает «заговор женщин», я делаю глоток."
