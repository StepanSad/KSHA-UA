...
n " {vspace=60}最近、屋上に上がるのがごく自然なことと思うようになっている。妙な感じだ。"
...
n " {vspace=150}最後に岩魚子と会ったときは、ひどく気まずかった。恥ずかしくなるくらいに。彼女は俺の病室に来て、義理っぽくリンゴをむいてくれて、その後は３０分間お互いに一言も話さなかった。"
...
n " {vspace=120}岩魚子はあまりに後ろめたそうに見えて、俺は気分を悪くさせるようなことを言いたくなかった。どんなことを言えばよかったのか、俺にはさっぱり分からなかった。"
...
n " {vspace=60}笑美がここにいないのは変な感じだった。"
...
n " {vspace=60}好きだと伝えたい、きれいだと思っていると伝えたい、必要な時はそばにいると伝えたい。"
...
n " {vspace=180}笑美の健康状態にやけにご執心の、例の陸上部の部長。"
...
n " {vspace=120}部活の練習の時以外に二人でいるところを見たわけでもない。"
...
n " {vspace=180}でも誰があの二人の関係をはっきりとさせられるんだろう？"
...
n " {vspace=150}ナースに聞けばどうにかなるか？　笑美をとても気遣っているように見える。もしなにかあったら知っているはず……"
...
n " {vspace=120}俺がトラックに来ても笑美がいる様子はない。まだ具合が悪いんだろうか？"
...
n " {vspace=210}週末の予定が空いているか確認するにしては、ひどく遠回りな方法だ。"
