...
n " {vspace=270}翌日、言うべきなのに言えなかったこと、その機会を逃したことがどっとのしかかってくる。今となってはくよくよと考え込むことしかできない。"
...
n " {vspace=270}２日目。心配になってくる。その心配が疑わしく思えてきてバカみたいな気分になる。今でも琳のこと以外は考えられないおかげで、余計にそう思う。"
...
n " {vspace=270}３日目。国語のテスト、と同時に、世界史のテストがある。参った。あいつの一番嫌なところは、まるっきり別のことに集中しなきゃいけないのに、俺をこんなにひどい気分にさせるってことだ。"
...
n " {vspace=270}４日目。数学のテスト。なんと数学のテストだ。なるようになる。どうでもいい。"
...
n " {vspace=270}５日目。野宮先生がまた展覧会のオープニングに出席するか聞いてくる。行かないと言ってやりたくて仕方ないけど、先生にノーとはいえない。とにかく先生と琳に関することは一切話したくないので、無難な答えを返しておくのがいいってことだ。"
...
n " {vspace=60}琳に向かって溜まりに溜まった怒りをぶつけると、巨大な重しが心臓から取り外されたような気分になった。"
...
n " {vspace=30}あれは俺の本音だった。でもあんな風に怒りをぶちまけて何かいいことがあるか？　あるわけがない。"
...
n " {vspace=60}琳もきっと怒ってるだろう。自分の取った態度よりも、琳の反応のほうがショックだった。"
...
n " {vspace=30}琳はいつも周囲から距離を置いていて、変わることがないとずっと思っていた。だから怒鳴ったあとに琳があんなに怒ったのを見て……琳らしくないと思った。"




n " {vspace=30}琳は俺の気持ちをわかってくれたんだろうか？"
...
n " {vspace=30}そうすると結局、琳も俺たちと同じってことかもしれない。"
...
n " {vspace=30}ほんとにうんざりする。今の琳との関係を考えれば、ただここから抜け出して、ケリがついたふりをするなんてできないと思う。"




n " {vspace=30}それに今、琳は別の問題を抱えている。展覧会のオープニングはいい骨休めになると思っていたけど、それはとんでもない間違いだった。"




n " {vspace=60}話がどんどんもつれていっている気がする。"
...
n " {vspace=90}特に何を描くつもりでもなかったからだろうか。"
...
n " {vspace=30}もっと才能があれば簡単なんだけどな、琳みたいに。"
...
n " {vspace=60}ここに来たときから、いつも不思議に思っていた。"
...
n " {vspace=60}重力と概念的に等価な何かに逆らうかのように、琳は狂気や不可解さ、不安定さの隙間をぬうような、細いジグザグの線の上でバランスをとっている。"
...
n " {vspace=60}この気持ちは本当に愛なんだろうか。それとも俺が思い違いをしているだけなのか。"
...
n " {vspace=60}それから一日中、琳や病院、山久や夏休みのことが頭を駆けめぐった。"



n " {vspace=30}集中することにさえ集中できない。"



n " {vspace=30}考えがでたらめに浮かんでは消え、小さすぎる思考のかけらへとばらばらに崩れていく。"




n " {vspace=30}俺は本を拾い上げてどうにか１００ページ読み進めたけど、明日までにはどういう話だったのかきれいさっぱり忘れている自信がある。"




n " {vspace=30}部屋を掃除しようとするけど、それさえわずらわしいことだった。時間がかかりすぎるし、細かいところにより多くの注意を払わなきゃいけない。"
...
n " {vspace=60}どっちにしろ明日は街に出る。買い物でもしよう。"
...
n " {vspace=30}琳はうまくやっているときでさえ、優柔不断すぎる。あのときの『めまいの発作』みたいに。"
...
n " {vspace=90}こんなの意味がない。"




n " {vspace=30}琳はなにを成し遂げたかったんだ？　オープニングの日の夜に琳の言葉を聞いたとき、琳はなにか……なにか特別なものを求めていたような気がした。"
...
n " {vspace=30}でも、それは誰にも邪魔されない個人的な世界に引きこもる理由にはならない。"

nvl clear



n " {vspace=90}すべてが自分の思い通りになる、歪んだ誇大妄想めいた宇宙論にあてはまるように世界をねじ曲げることはできない。"





n " {vspace=30}琳のそういうところが一番イライラする。"





n " {vspace=30}琳は世界を自分のルールに従わせたいと思っている。ルールに合わないすべてのものは無意味だとか不要なものだとして無視している。"
...
n " {vspace=90}だから俺たちはこんなことを続けるのか？　俺もつらいけど、同じくらいお前もつらいんだ。俺たちのどちらにも役には立ちそうにない。"
...
n " {vspace=120}女の子を泣かせるのは一番卑劣な行いだ。"


n " {vspace=30}それが琳であっても。琳だからこそ。"


n " {vspace=30}超然としているその裏では、琳もひとりの人間だったんだ。"
...
n " {vspace=60}でもそれを説明できる言葉も、慰める言葉も存在しない。"
...
n " {vspace=150}だから、俺たちは言葉もなく立ち尽くし、静かに涙が涸れるのを待っている。"
...
n " {vspace=60}俺たちは決して、相手のためにと自分が望んでいるような存在にはなれないかもしれない。そんな実感がダイヤモンドのように硬い悟りへと結晶化する。"
...
n " {vspace=30}俺はいつ琳のことを好きになったんだろうか？"
...
n " {vspace=60}気づかないうちに、あの抗いようのない力が俺を危険なほど近くに琳に引きつけたけど、でも結局、それは俺にとって異質すぎるものだった。"
...
n " {vspace=30}そんなことを考えて笑ってしまいそうになる。確かに、琳は本当に別の星から来たように思えることがある。緑の肌と触手はないけど。"
...
n " {vspace=60}ああ、わかってる。こんなことになるなんて間違ってる。"
...
n " {vspace=30}こんな関係はうまくいくのか？　俺たちはもっと親しい関係へと変われるんだろうか？"
...
n " {vspace=60}琳は瞬間、気まぐれ、そして衝動の生き物だ。"




n " {vspace=30}俺とは似ても似つかない。"



n " {vspace=30}これははっきりと理解できる事実だ。"
...
n " {vspace=30}俺たちには手放すことのできないもの、考えずにはいられないものがある。"
...
nb "『今』なんて、あやふやですぐに過ぎ去ってしまうものだ。 {vspace=90} "



extend "過去と未来の間にある瞬間？ {vspace=90} "




extend "そんな説明に大した意味はない。 {vspace=90} "





extend "無意味なことを深く考えすぎても時間の無駄だ。 {vspace=90} "




extend "だから今を生き抜くことはいつでも最高の選択というわけだ。 {vspace=90} "




extend "第一、未来を予測することもできず、過去も簡単に忘れてしまう俺たちにとって、今というのは唯一の存在の証明だ。 {vspace=90} "




extend "しばらくそのことを忘れていても、存在することには変わりはない。でもたまにはその一瞬を楽しむのもいいものだ。 {vspace=90} "
...
n " {vspace=60}琳がそんなことを言える、ということが嬉しくはあるけど、やっぱり俺は悲しくなる。"
...
n " {vspace=60}俺たちはしばらくの間、それに耳を傾ける。"
...
n " {vspace=90}いいだって？　琳の決めることはいつもこう……型破りだ。"
