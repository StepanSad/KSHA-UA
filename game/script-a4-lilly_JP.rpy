...
n " {vspace=90}北海道旅行を存分に楽しんだ後では、こんなにも早く日常生活に戻ってくるのがおかしな感じがする。まさしく、いつもと全く変わらない、普通の一日みたいだ。"



n " {vspace=30}まあとにかく、俺はそう思いたい。"


n " {vspace=30}本当のことを言うと、クラス全体、いや、学校全体の雰囲気が変わってしまっている。"
...
n " {vspace=60}ここでの生活が始まって以来、この単純な思いが数えきれないくらい何度も俺の心を捕え続けてきた。"
...
n " {vspace=60}だけどそんな状況下では、現地の言葉もすぐ身に付けることができるだろう。そうしなきゃ生きていけないんだ。言い換えれば、『おぼれるか泳ぐか』という二者択一の状況になる。"



n " {vspace=30}ここで時を過ごしてきた俺は、ちゃんと泳げているんだろうか。"
...
n " {vspace=60}時にはひどくぞっとするような障害や症状を持つ人々に囲まれた環境にも、あっという間に慣れてしまうというのは本当に驚きだ。"
...
n " {vspace=30}社交性がないとか友人がいないってわけじゃない。ほとんどのクラスメイトとはとても仲良くなったし、他にも校内に何人か知り合いがいる。腕や脚がなくたって、ここの生徒は同世代の他の少年少女と何も変わらない。"





n " {vspace=60}一度は迷ってしまい、絶対に覚えられないと思った学校の廊下も、理にかなった建物のレイアウトのおかげで今では簡単に移動できる。先生たちとは気さくな議論を交わすことができる。"
...
n " {vspace=90}古風すぎる傾向のあるリリーが、実際に会えないような関係にうまく馴染めるはずがない。俺だってある程度はそうだ。お互いの触れ合いが地球の反対側から届く声だけになるなんて。"
...
n " {vspace=90}全部無意味だったんだ。全部、青春のつかの間の出来事に過ぎなかったんだ。"
...
n " {vspace=60}リリーが彼女の計画を俺に打ち明けたのは数日前のことだ。あれ以来、日常だったリリーとつるむ昼食時間ともご無沙汰だ。そんなことはさして重要でもないけど。"
...
n " {vspace=90}俺のやることといったら、実家に帰って住み慣れた家で夏休み中ダラダラ過ごすだけだろう。俺の以前立てた計画が完全にねじ曲げられた今となってしまっては。"
...
n " {vspace=60}一方で、晃さんとリリーはスコットランドに渡って、残りの人生をそこで過ごすんだろう。"
...
n " {vspace=60}少なくとも、それについては俺も喜ぶべきなんだろう。だけど、そんなのは慰めになりそうにない。"
...
n " {vspace=90}華子の休み中の計画は、親に言われるがまま家族と過ごすことにしている俺のとはまるで正反対だ。"
...
n " {vspace=30}心臓発作が起こる前の俺は何の目的もなく生活していたので、休日も普段の日常と大差なかった。"
...
n " {vspace=90}だけど山久に来てから、俺は根本的に生まれ変わったような気がする。その点について多少の不安はあったかもしれないけど、電話で両親と話した時には全部消え去ってしまった。"
...
n " {vspace=30}こうして考えてみると、たとえ親が家にずっといなくても、俺はいつも親に依存していたんだ。だけど山久の寮に入ってからは誰にも頼らずに生活してきたと言えば、それは嘘になる。"
...
n " {vspace=60}初めて会った時のリリーは他人行儀で、何だかよそよそしかったような気もする。いつも自分の行動は注意深く、慎重かつ正確で、神経の行き届いた冷静沈着な様子はいつも確かな自信と気品に満ちあふれていた。"
...
n " {vspace=30}だけど今、俺はそのことに疑いを持ち始めている。"



n " {vspace=30}俺たち２人が事実上破局した後でそんな疑いが浮かぶのも、きっと分かり切っていたことなんだ。だけどそれは目新しくもないし、奇妙でもない。むしろ昔読んだ本を見つけてほこりを払っているような感じさえする。"
...
n " {vspace=60}だけどそのうち、俺にとってリリーとの時間がどんどん大切なものになっていった。静かな散歩の時間から昼食のおしゃべりに至るまで。リリーのいい所がどんどん見えてきて、それがどんどん愛おしくなっていった。"
...
n " {vspace=30}だけど、きっとリリーにとってそれは俺たちの関係の全てじゃなかったんだ。"


n " {vspace=30}日本に帰国しても、それはリリーにとって、ほんの短時間会うことができた家族を再び失う、ということに過ぎなかった。"
...
n " {vspace=30}俺は、リリーの独立志向は素晴らしく賞賛に値するとずっと思っていた。心臓発作が起こる前の俺は、認めたくはなかったけど、両親に頼り切っていた。リリーはそんな俺とは大違いだ。"
...
n " {vspace=30}そして今、晃さんはインヴァネスに発つ。ちょうどリリーが失ったと感じていた家族と同じように。"
...
n " {vspace=30}疑いもしなかった。俺は、リリーのそばにいようともせず、リリーが望んでいることを聞いたりもしなかった。"
...
n " {vspace=30}俺の胸に、自分に対するいらだちと怒りがふつふつと湧き上がる。"





n " {vspace=30}俺はただ事態を見守っていただけで、リリーを助ける努力すらしようともしなかった。"



n " {vspace=30}リリーがいてくれるだけで十分だった。それが本当なら、俺はこれからもうまくやっていけると思っていた。"
...
n " {vspace=30}妙な言葉だ。耳慣れない、知らない言葉。お近づきにはなりたくない言葉。"
...
n " {vspace=30}『今まで何の問題もなく過ごせていたのは奇跡的だ』と言われた。"
...
n " {vspace=60}通りを行く人たちは時々いぶかしげにこちらを見たり、じろじろ見ている自分に気づいて慌ててそっぽを向いたりした。俺の病気は目には見えないけど、俺の制服はそれを表に示していたんだ。"
...
n " {vspace=30}でも大したことじゃなかった。そのくらいなら耐えられた。"
...
n " {vspace=30}それは、俺の眼の前から再び奪い取られてしまったもの。"


nvl clear


n " {vspace=30}俺が新たに見つけた幸せがいかに繊細なものだったのか、今になってようやく気づく。全て彼女に依存していたんだ。陰うつで、戸惑い、目的もない、そんな転校生だった俺が最初に山久に来てから、ずっと俺の人生のかなめだった彼女。"
