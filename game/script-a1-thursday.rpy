...
show ev showdown_large:
    size (1920,1080)  crop (0, 0, 5760, 3240)  subpixel True 
    easeout 0.2  crop (280*2.4, 100*2.4, 1920*1.15,1080*1.15)
with None
...
show ev showdown_large:
    ease 0.2  crop (1400*2.4,160*2.4, 1920*1.15,1080*1.15) 
with None
...
play sound sfx_slide2
show ev showdown_large:
    ease 0.2  crop (280*2.4,100*2.4, 1920*1.15,1080*1.15) 
with None
